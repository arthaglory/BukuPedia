...
class Barangkeluar extends CI_Controller
{
    ...
    private function _validasi()
    {
        ...
        $stok = isset ($this->admin->get('barang', ['id_barang' => $input])['stok']) ? $this->admin->get('barang', ['id_barang' => $input])['stok']:'';
        array ($stok_valid = ($stok) + 1);
    ...
    public function add()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            if ($insert) {
                ...
                set_pesan('Wow ada kesalahan nich!');
